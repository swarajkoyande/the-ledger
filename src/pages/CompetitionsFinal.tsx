...
export default function CompetitionsFinal() {
      ...
      >
        ...
        >
          ...
          <div style={{
            ...
            <div style={{ fontSize: '3.5rem', fontWeight: 900, color: '#F97316', lineHeight: 1, textShadow: '0 0 30px rgba(249,115,22,0.4)' }}>{activeCount}</div>
          </div>
                      ...
                      {comp.status === 'Open' ? (
                        ...
                        <span
                          style={{
                            ...
                            textDecorationColor: 'rgba(196,168,130,0.25)',
                          }}
                        >
                          Coming Soon
                        </span>
